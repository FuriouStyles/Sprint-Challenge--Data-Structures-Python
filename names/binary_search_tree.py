...
class BSTNode:
    ...
    def in_order_print(self):
        # recursive = place your print statemtn in between recursive calls
        # that expore lef & right subtrees

        # iterative - think about the order in which we are adding nodes to the stack
    ...
    def dft_print(self):
        ...
        # while something still in the stack (not done processing all nodes)
          ...
          # + 
          # use existing 'fore_each()' as a reference for traversal logic
          # call print() at some point
        pass
